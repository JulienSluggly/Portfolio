...
function handleTextureData(gl, data) {
...
function handleDepthIndex(gl, data) {
    const { depthIndex, viewProj } = data;
...
function setupWorker() {
    worker.onmessage = (e) => {
        if (e.data.texdata) {
            handleTextureData(gl,e.data);
        }
        else if (e.data.depthIndex) {
            handleDepthIndex(gl,e.data);
            vertexCount = e.data.vertexCount;
        }
    };
}
